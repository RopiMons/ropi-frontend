    ...
    return (
        <>
            ...
            <Container className="py-xl-5" id="passez-action">
                ...
                <h4 className="text-center subtitle font-weight-normal">Le Ropi n&#39;attend que vous pour relocaliser
                    l&#39;économie. Il existe plein de façons de participer !</h4>
            </Container>
            ...
            <Carte2Col
                carteGauche={
                    <>
                        ...
                        <img className="img-fluid" id="valeurs" src={imageIncluse[0]} alt={"valeurs"}/>
